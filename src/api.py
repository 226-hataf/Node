...
from business.models.users import UserLoginSchema, ResetPasswordSchema
...
async def user_login(user_info: ResetPasswordSchema):
    try:
        return auth_provider.reset_password(user_info)
