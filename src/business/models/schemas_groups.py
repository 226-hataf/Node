...
class GroupSchema(GroupBaseSchema):
    ...
    users_id_in_group: list[Optional[UUID]] = Field(description="User's uuid's in a group", title="User's uuid's")
    users_name_in_group: list[Optional[str]] = Field(description="User's name's in a group", title="User's name's")
